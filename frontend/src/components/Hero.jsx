      ...
      <div className="content-grid">
        <div className="left-column">
          ...
          <p className="hero-intro">
            Hi, I'm Tshedza Mosehane, a student developer and designer studying
            Creative Technologies at the Open Window Institute.
          </p>
